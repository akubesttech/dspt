...
$comn="Delta state Smart Education DSPT";
...
{if($tid[0] == null){$tmax="10001";}else{$tmax=$tid[0]+1;}}
...
$matno ="DSPT/".($dID)."/".$yearadds."/".$maxadd;
//dep/level/year/no
//dspt/otm/1718/no
return $matno;
}
...
{if ($statnum==0){return "Others";}else if($statnum==1){return "Service Charge";}
